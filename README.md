...
3.  **fact_churn_events:** Granular cancellation data mapping churn reasons and financial impacts.
4.  **fact_feature_usage:** Daily product application logs tracking feature-level engagement.
5.  **fact_subscriptions:** Historical log of financial milestones, plan tiers, and MRR tracking.
